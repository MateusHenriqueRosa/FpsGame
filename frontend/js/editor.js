let scene, camera, renderer, controls;
        ...
        function onMapClick(event) {
            ...
            if (placingObjective) {
                placeObjectiveMarker(placingObjective, point);
                showMessage(`Site ${placingObjective} posicionado!`, 2200);
                placingObjective = null;
                return;
            }

            if (placingTeamSpawn) {
                placeTeamSpawn(placingTeamSpawn, point);
                return;
            }
